...
void admin_main() {
	...
	while (1) {
		...
		case 3: { system("cls"); Rent_list(Rent, CountRent); break; }			// 대여 목록

		case 4: { system("cls"); Manage_Video(); break; }						// 비디오 관리
				
		case 5: { system("cls"); Manage_Member(); break; }						// 회원 관리
